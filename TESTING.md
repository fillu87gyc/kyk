...
| CUJ-3 自機操作 | `test_player_logic`（calc_velocity / clamp / boost 系 24 本）| E2E-14, E2E-18 | ✅ |
| CUJ-4 弾幕出現 | `test_bullet_logic`（spawn/step 系 21 本）| E2E-7 | ✅ |
| CUJ-5 被弾 | `test_player_logic`（check_hit 系）, `test_hit_stop`(5) | E2E-3, E2E-4, E2E-16, E2E-17, E2E-21 | ✅ |
| CUJ-6 グレイズ | `test_player_logic`（check_graze 系）| E2E-5, E2E-17 | ✅ |
...
| CUJ-10 決定論 | `test_bullet_logic`（determinism 系）, `test_stage_dressing`（再現性1本）| — | ✅ |
| CUJ-11 ボス撃破 | `test_boss_state_machine`(11) | E2E-19, E2E-20, E2E-23 | ✅ |
...
|----------|-----------|--------|-----------|
| `PlayerLogic` | 4 | 4 | 24 |
| `BulletLogic`（+BulletState）| 7 | 7 | 21 |
| `ModLoader` | 1 | 1 | 4 |
| `BossPresenter` | 6 | 6 | 7 |
...
- **関数カバレッジ: 62/62 = 100%**
- **単体テスト本数 / 関数数 = 144 / 62 ≒ 232%**（＝「100% を超える単体テスト」）
